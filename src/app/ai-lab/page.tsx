...
const KIND_STYLES: Record<string, string> = {
  Prototype: "border-cyan-400/25 bg-cyan-400/10 text-cyan-200 light:border-cyan-700/25 light:bg-cyan-700/[0.07] light:text-cyan-800",
  ...
  Idea: "border-amber-400/25 bg-amber-400/10 text-amber-200 light:border-amber-700/25 light:bg-amber-700/[0.07] light:text-amber-800",
};
  ...
  return (
    <main className="relative min-h-screen bg-[#04060d] text-slate-100 light:bg-[#f3f5fa] light:text-slate-700">
        ...
        <div className="mx-auto grid max-w-6xl gap-4 px-5 sm:px-8 sm:grid-cols-2 lg:grid-cols-4">
          {LAB_AREAS.map((a, i) => (
            <Reveal key={a.title} delay={i * 80}>
              <div className="relative h-full overflow-hidden rounded-3xl border border-white/[0.09] bg-[#0a0f1e] p-6 light:border-slate-900/10 light:bg-white light:shadow-[0_16px_45px_-22px_rgba(15,23,42,0.18)]">
              ...
              <Reveal key={item.title} delay={(i % 3) * 80}>
                <div className="glass card-hover h-full rounded-3xl p-6">
                  <div className="flex items-center justify-between gap-2">
                    ...
                    <span className="flex items-center gap-1.5 text-[11.5px] font-medium text-emerald-300 light:text-emerald-700">
      ...
      <section className="relative py-12 pb-20 sm:py-16 sm:pb-24">
        <div className="mx-auto max-w-6xl px-5 sm:px-8">
          <Reveal>
            <div className="relative overflow-hidden rounded-[2rem] border border-white/[0.09] bg-gradient-to-br from-[#0b1024] to-[#160b24] p-8 text-center sm:p-12 light:border-slate-900/10 light:from-white light:via-indigo-50/60 light:to-fuchsia-50/60 light:shadow-[0_30px_80px_-30px_rgba(99,102,241,0.3)]">
