...
import { ECA_DETAILS } from "@/data/site";
        ...
        <div className="mx-auto grid max-w-6xl gap-5 px-5 sm:px-8">
              ...
              <article className="glass relative overflow-hidden rounded-3xl p-7 sm:p-9">
                <div className="grid gap-6 lg:grid-cols-[220px_1fr]">
                  <div>
                    ...
                    <h2 className="font-display mt-4 text-xl font-bold text-white">{a.title}</h2>
                  </div>
                  <div className="grid gap-4 sm:grid-cols-2">
                    {[
                      { t: "What I did", d: a.did, c: "text-cyan-300" },
                      { t: "Why I joined", d: a.why, c: "text-violet-300" },
                      { t: "What I learned", d: a.learned, c: "text-amber-300" },
                      { t: "Impact I created", d: a.impact, c: "text-emerald-300" },
                    ].map((b) => (
                      <div key={b.t} className="rounded-2xl border border-white/[0.07] bg-white/[0.02] p-4">
                        <p className={`text-[11px] font-bold uppercase tracking-[0.16em] ${b.c}`}>{b.t}</p>
                        <p className="mt-1.5 text-[13px] leading-relaxed text-slate-300">{b.d}</p>
                      </div>
                    ))}
                  </div>
                </div>
          ...
          <Reveal delay={100}>
            <div className="mx-auto max-w-3xl rounded-3xl border border-white/[0.08] bg-gradient-to-r from-cyan-500/[0.07] via-violet-600/[0.07] to-fuchsia-500/[0.07] p-7 text-center sm:p-9">
              <p className="font-display text-[16px] font-bold text-white sm:text-lg">
