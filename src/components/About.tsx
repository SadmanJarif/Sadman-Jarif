          ...
          <Reveal>
            <div className="glass card-hover relative h-full overflow-hidden rounded-3xl p-7 sm:p-9">
              ...
              <p className="mt-4 text-[14.5px] leading-relaxed text-slate-400">
                I started by exploring everything that caught my eye — web development, Flutter,
                WordPress, digital marketing, AI systems, software development. I said yes to a lot
                of things, built a lot of imperfect things, and learned what actually stuck.
              </p>
              <p className="mt-4 text-[14.5px] leading-relaxed text-slate-400">
                Over time my interests sharpened around{" "}
                <span className="font-semibold text-slate-200">
                  AI, computer science and entrepreneurship
                </span>
                . Today I&apos;m continuously learning, experimenting, building projects, gaining
                professional experience — and looking for opportunities where I can create meaningful
                impact.
              </p>
              <p className="mt-4 text-[14.5px] leading-relaxed text-slate-400">
                I don&apos;t have everything figured out. But I show up, I ship, and I keep raising
                the bar.
              </p>
              ...
              <div className="mt-6 flex flex-wrap gap-2">
                {JOURNEY.map((j) => (
                  <span
                    key={j}
                    className="rounded-full border border-white/10 bg-white/[0.04] px-3.5 py-1.5 text-[12px] font-medium text-slate-300"
                  >
                    {j}
                  </span>
                ))}
            ...
            {TRAITS.map((t, i) => (
              <Reveal key={t.title} delay={i * 90}>
                <div className="glass card-hover h-full rounded-3xl p-6">
                  <span className="inline-flex h-9 w-9 items-center justify-center rounded-xl bg-gradient-to-br from-cyan-500/25 to-violet-600/25 text-cyan-300">
                    <CheckIcon className="h-4 w-4" />
                  </span>
                  <h3 className="font-display mt-4 text-[15px] font-bold text-white">{t.title}</h3>
                  <p className="mt-1.5 text-[13px] leading-relaxed text-slate-400">{t.text}</p>
                </div>
              </Reveal>
            ))}
          </div>
