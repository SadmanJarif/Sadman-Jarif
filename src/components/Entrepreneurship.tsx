  ...
  return (
    <section id="ventures" className="relative scroll-mt-28 py-20 sm:py-28">
      <div className="mx-auto max-w-6xl px-5 sm:px-8">
        <Reveal>
          <div className="relative overflow-hidden rounded-[2rem] border border-white/[0.09] bg-gradient-to-br from-[#0b1024] via-[#0d0a24] to-[#160b24] p-8 sm:p-12 lg:p-14 light:border-slate-900/10 light:from-white light:via-indigo-50/60 light:to-fuchsia-50/60 light:shadow-[0_30px_80px_-30px_rgba(99,102,241,0.3)]">
            ...
            <div className="relative grid gap-10 lg:grid-cols-[1fr_1fr] lg:gap-12">
              <div>
                <span className="inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/[0.05] px-4 py-1.5 text-[11px] font-bold uppercase tracking-[0.18em] text-amber-200 light:border-amber-700/20 light:bg-amber-500/10 light:text-amber-800">
                  <span className="h-1.5 w-1.5 rounded-full bg-amber-300 shadow-[0_0_12px_rgba(252,211,77,0.9)]" />
                  Entrepreneurship
                </span>
                <h2 className="font-display mt-5 text-3xl font-extrabold leading-[1.08] tracking-tight text-white sm:text-4xl lg:text-[2.9rem] light:text-slate-900">
                  I don&apos;t just want a job.{" "}
                  <span className="text-gradient">I want to build companies.</span>
                </h2>
                <p className="mt-5 max-w-lg text-[14.5px] leading-relaxed text-slate-300/90 sm:text-[15.5px] light:text-slate-600">
              ...
              <div className="grid gap-3 sm:grid-cols-2">
                {PILLARS.map((p, i) => (
                  <Reveal key={p.title} delay={i * 90}>
                    <div className="h-full rounded-2xl border border-white/10 bg-black/30 p-5 backdrop-blur-md transition-all duration-300 hover:border-cyan-400/25 hover:bg-black/45 light:border-slate-900/10 light:bg-white/80 light:shadow-sm light:hover:border-cyan-700/30">
                      <span className="flex h-10 w-10 items-center justify-center rounded-xl bg-gradient-to-br from-cyan-500/30 to-violet-600/30 text-lg text-cyan-200 light:text-cyan-800">
                        {p.icon}
                      </span>
